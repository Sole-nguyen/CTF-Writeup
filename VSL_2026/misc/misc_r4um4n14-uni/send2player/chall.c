...
int math_func(unsigned long long x, unsigned long long y,
    ...
    if ( 1 * x + 3 * y + 3 * z - 7 * t != (unsigned long long) (out_put_0 * 2) ) {
        return 0; 
    }

    if ( 1 * x + 1 * y + 1 * z + 1 * t != (unsigned long long) (out_put_1 / 24012026) ) {
        return 0; 
    }

    if ( 3 * x - 1 * y + 1 * z + 1 * t != (unsigned long long) (out_put_2 / 11112024) ) {
        return 0; 
    }

    if ( 1 * x + 1 * y + 2 * z + 2 * t != (unsigned long long) (out_put_3 / 22012026) ) {
        return 0; 
    }
